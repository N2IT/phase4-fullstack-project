            ...
            <Container>
                <div className="account-details">
                    ...
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <Row>
                            <Col md={3} xs={12}>
                                <Form.Label htmlFor="quote_id">Quote Id </Form.Label><br />
                                <Form.Control
                                    id="quote_id"
                                    name="quote_id"
                                    onChange={formik.handleChange}
                            ...
                            <Col md={3} xs={12}>
                                <Form.Label htmlFor="created_by">Created By </Form.Label><br />
                                <Form.Control
                                    id="created_by"
                                    name="created_by"
                                    onChange={formik.handleChange}
                        ...
                        <div className="d-flex justify-content-end gap-2">
                            <p><Button variant='primary' type="submit">Submit</Button></p>
                        </div>
                    </form>
...
export default NewConfigFormReference